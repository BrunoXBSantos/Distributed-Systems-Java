...
Na figura 4.2 mostra o registo no programa cliente de uma utilizador cujo nome é \textit{Bruno}. De seguida recebe duas estimativas do servidor. Cada estimativa contêm a proporção de infetados atual e a data calculada da respetiva estimativa. 
...
Na figura 4.3 apresenta algumas mensagens trocadas entres os clientes e o servidor. Por exemplo, os utilizadores pedro e flavia comunicaram que todos os contactos conhecidos estão infetados e o utilizador Bruno fez \textit{logout}.
